...
def update_position():
    ...
    dpg.configure_item("card_1", pos=(margin, margin))
    dpg.configure_item("chip_1", pos=(margin, margin + img_size + margin))
    dpg.configure_item("machine_1", pos=(margin, margin + 2 * (img_size + margin)))

    dpg.configure_item("card_2", pos=(width - img_size - margin, margin))
    dpg.configure_item("chip_2", pos=(width - img_size - margin, margin + img_size + margin))
    dpg.configure_item("machine_2", pos=(width - img_size - margin, margin + 2 * (img_size + margin)))
